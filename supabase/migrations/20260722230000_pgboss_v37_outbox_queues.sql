...
SELECT pgboss.create_queue('outbox-dispatch-dead-letter', '{"policy":"standard","retryLimit":0,"deleteAfterSeconds":2592000}'::jsonb);
    COMMIT;
...
SELECT pgboss.create_queue('outbox-dispatch', '{"policy":"standard","retryLimit":5,"retryDelay":5,"retryBackoff":true,"retryDelayMax":300,"deadLetter":"outbox-dispatch-dead-letter","heartbeatSeconds":60}'::jsonb);
    COMMIT;
